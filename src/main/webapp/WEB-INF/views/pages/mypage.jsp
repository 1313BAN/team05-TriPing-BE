...
<body>
    ...
    <div class="container mt-5">
        ...
        <form id="userForm" action="${root}/users?action=edit&userId=${user.userId}" method="post">
            <div class="card">
                <div class="card-body">
                    <p class="card-text"><strong>이메일:</strong> <span id="emailDisplay">${user.userEmail}</span>
                        <input name="email" type="email" id="emailInput" class="form-control editable-input" value="${user.userEmail}" />
                    </p>
                    <p class="card-text"><strong>비밀번호:</strong> <span id="passwordDisplay">******</span>
                        <input name="password" type="password" id="passwordInput" class="form-control editable-input" value="" />
                    </p>
